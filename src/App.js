  ...
  return (
      <><div className="App">
          ...
          <header className="App-header">
              <h1>How To Get React</h1>
              <hr />
              <div className="w3-panel w3-note">
                  <p>To use React in production, you need npm which is included with
                      <a href="https://nodejs.org" target="_blank">Node.js</a>.</p>
              </div>


              <p>To get an overview of what React is, you can write React
                  code directly in HTML.</p>
              <p>But in order to use React in production, you need npm and
